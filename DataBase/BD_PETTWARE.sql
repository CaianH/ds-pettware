...
call inserirCliente ('Fernando', '031188143', '1527306', '2000-12-02','324555', 'Fernandin@gmail.com', 'ji-paraná', 'Brasileiro', 1);
...
call inserirFuncionario ('Pablo', '16229144', '296053', '1994-05-02','324555', 'pablo@gmail.com', 'ji-paraná', 'Brasileiro', 1);
...
delimiter $$
create procedure inserirVenda (codcli int, codfunc int, datavenda date, valortotal double, formapagamento varchar(50))
begin
declare func_aux int;
declare cli_aux int;
set func_aux = (select cod_func from Funcionario WHERE cod_func = codfunc);
set cli_aux = (select cod_cli from Cliente WHERE cod_cli = codcli);
	...
	IF (codfunc = func_aux)THEN
		IF (codcli = cli_aux)THEN
		 Insert into Venda values(null, codcli, codfunc, datavenda, valortotal, formapagamento);
...
call inserirVenda (1,1,'2020-08-30',20,'Cartão Débito');
...
call inserirProduto('Ração para gatos 5kg', 45, 65, 65);
